  ...
  return (
    <div className="relative" ref={datePickerRef}>
      ...
      <div
        ...
        className={`w-full text-[10px] h-10 px-3 py-2 rounded-lg border cursor-pointer flex items-center justify-between transition-all duration-200 ${
          theme === "dark"
      ...
      {isOpen && (
        <div
          className={`absolute top-full left-0 mt-2 w-50 p-4 rounded-xl shadow-2xl border z-50 ${
            theme === "dark"
          ...
          <div className="grid grid-cols-7 gap-1 ">
            {getDaysInMonth(currentDate).map((date, index) => (
              <button
                ...
                disabled={!date}
                className={`p-2 text-[10px] rounded-lg transition-all duration-200 ${
                  !date
                    ? "invisible"
                    : isSelected(date)
...
function Search({
  ...
  return (
    <div className="space-y-4">
      {/* Search Input */}
      <div
        className={`w-full h-12 rounded-xl flex items-center transition-all duration-200 border shadow-sm ${
          theme === "dark"
      ...
      >
        ...
        <input
          ...
          className="w-full h-full bg-transparent outline-none text-sm pl-4 placeholder-opacity-50"
          maxLength={30}
        />
        <button
          onClick={() => setShowFilters(!showFilters)}
          className={`p-2 border-l border-gray-900/20 mr-2 transition-colors ${
            theme === "dark" ? " text-gray-300" : " text-gray-600"
          }`}
        >
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {filterOptions.map((filter) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg text-[10px] font-medium transition-all duration-200 flex items-center gap-2 ${
            ...
            {enableSupplier && (
              <div className="space-y-2">
                ...
                <select
                  ...
                  className={`w-full h-10 px-3 rounded-lg text-sm border transition-colors ${
                    theme === "dark"
                      ? "bg-gray-800 border-gray-700 text-gray-200"
          ...
          <div className="flex justify-between items-center mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
            ...
            >
              {activeFilters.length +
                ...
                (enableSupplier && selectedSupplier ? 1 : 0)}{" "}
              filter(s) active
            </span>
            <button
              onClick={() => {
