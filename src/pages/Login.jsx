...
const Login = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "OTP sent successfully to your email address. Please check your inbox.",
      });
    } catch (err) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const loginResponse = await axiosInstance.post("/auth/login", { email });
  ...
  /**
   * Resets the OTP flow to allow email address change
  ...
  /**
   * Handles email address input changes
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-200 ${theme === "dark" ? "bg-gray-900" : "bg-neutral-200"}`}
    >
      ...
      <div className="w-full max-w-md mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:max-w-lg">
        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          ...
          <div className="text-center">
            <h1
              className={`text-lg sm:text-xl font-semibold mb-2 transition-colors duration-200 ${theme === "dark" ? "text-gray-100" : "text-gray-900"}`}
            >
              Welcome Back
            </h1>
            <p
              className={`text-sm transition-colors duration-200 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}
            >
          ...
          {message.text && (
            <div
              className={`p-3 sm:p-4 rounded-lg text-sm font-medium transition-all duration-200 ${
          ...
          {/* Form Card */}
          <div
            className={`px-4 py-6 sm:px-6 sm:py-8 border-4 border-l-0 border-r-0 border-yellow-400 rounded-lg transition-colors duration-200 ${theme === "dark" ? "bg-gray-800" : "bg-white"} shadow-lg`}
          >
            ...
            <div className="flex flex-col gap-4 sm:gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label
                  className={`text-sm font-medium transition-colors duration-200 ${theme === "dark" ? "text-gray-100" : "text-gray-900"}`}
                >
                  Email Address *
                </label>
                <input
                  ...
                  className={`h-10 sm:h-12 rounded-xl outline-none px-3 py-2 text-sm transition-all duration-200 border ${
                    theme === "dark"
              ...
              {!otpSent ? (
                ...
                <button
                  ...
                  className={`w-full h-10 sm:h-12 rounded-xl font-semibold text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50 ${
                    loading || !email
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className={`h-10 sm:h-12 rounded-xl outline-none px-3 py-2 text-sm transition-all duration-200 border text-center tracking-widest ${
                        theme === "dark"
                          ? "bg-gray-700 text-gray-100 border-gray-600 focus:border-blue-400"
                          : "bg-neutral-200 text-gray-900 border-gray-300 focus:border-blue-500"
                      } ${message.type === "error" && otpSent ? "border-red-500 focus:border-red-500" : ""} focus:outline-none focus:ring-2 focus:ring-opacity-50 ${theme === "dark" ? "focus:ring-blue-400" : "focus:ring-blue-500"}`}
                  ...
                  <button
                    ...
                    disabled={loading}
                    className={`text-xs underline mt-2 text-center transition-colors duration-200 ${
                      loading
                        ? theme === "dark"
            ...
            <div className="flex flex-col items-center mt-6 pt-4 border-t border-opacity-20 border-gray-400">
              <p
                className={`text-sm mb-2 transition-colors duration-200 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}
              >
